...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    //[REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, EVER_GRANDE_CITY),		//E4 rematch
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE_2, TRAINER_WALLACE_2, TRAINER_WALLACE_2, TRAINER_WALLACE_2, EVER_GRANDE_CITY), //end section
};
...
static void SetRematchIdForTrainer(const struct RematchTrainer *table, u32 tableId)
{
    ...
    #ifndef FREE_MATCH_CALL		//saveblock cleansing
