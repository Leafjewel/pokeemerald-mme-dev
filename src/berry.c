...
static const u8 sBerryDescriptionPart2_Oran[] = _("BERRIES grow in just a day.");
...
static const u8 sBerryDescriptionPart2_Razz[] = _("and its center has a dry taste.");
...
static const u8 sBerryDescriptionPart1_Pomeg[] = _("When the sweetly spicy thick skin is");
static const u8 sBerryDescriptionPart2_Pomeg[] = _("peeled, many pieces of fruit spill out.");
...
static const u8 sBerryDescriptionPart2_Tamato[] = _("Warms the body from inside when eaten.");
...
/*static const u8 sBerryDescriptionPart1_Micle[] = _("This Berry has a very dry flavor.");
static const u8 sBerryDescriptionPart2_Micle[] = _("It makes other food taste sweet.");
static const u8 sBerryDescriptionPart1_Custap[] = _("The flesh underneath the tough skin");
static const u8 sBerryDescriptionPart2_Custap[] = _("is sweet and creamy soft.");
static const u8 sBerryDescriptionPart1_Jaboca[] = _("The cluster of drupelets that make up");
static const u8 sBerryDescriptionPart2_Jaboca[] = _("this Berry pop if handled roughly.");
static const u8 sBerryDescriptionPart1_Rowap[] = _("In the days of old, people worked the");
static const u8 sBerryDescriptionPart2_Rowap[] = _("tops of this Berry into toys.");*/
