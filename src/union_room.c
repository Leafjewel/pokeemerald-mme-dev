...
//static void ItemPrintFunc_PossibleGroupMembers(u8, s32, u8);	//tm shops
...
void ItemPrintFunc_PossibleGroupMembers(u8 windowId, s32 itemId, u8 y, u8 itemPos);
void ListMenuItemPrintFunc_UnionRoomGroups(u8 windowId, s32 itemId, u8 y, u8 itemPos);
void TradeBoardListMenuItemPrintFunc(u8 windowId, s32 itemId, u8 y, u8 itemPos);
...
//static void ItemPrintFunc_PossibleGroupMembers(u8 windowId, s32 id, u8 y)		tm shops
void ItemPrintFunc_PossibleGroupMembers(u8 windowId, s32 id, u8 y, u8 itemPos)
{
    struct WirelessLink_Leader *data = sWirelessLinkMain.leader;
...
//static void ListMenuItemPrintFunc_UnionRoomGroups(u8 windowId, s32 id, u8 y)	tm shops
void ListMenuItemPrintFunc_UnionRoomGroups(u8 windowId, s32 id, u8 y, u8 itemPos)
{
    struct WirelessLink_Group *data = sWirelessLinkMain.group;
...
//void nullsub_14(u8 windowId, s32 itemId, u8 y)	tm shops
void nullsub_14(u8 windowId, s32 itemId, u8 y, u8 itemPos)
{
...
//static void TradeBoardListMenuItemPrintFunc(u8 windowId, s32 itemId, u8 y)	tm shops
void TradeBoardListMenuItemPrintFunc(u8 windowId, s32 itemId, u8 y, u8 itemPos)
{
    struct WirelessLink_Leader *data = sWirelessLinkMain.leader;
