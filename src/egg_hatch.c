...
{
    u16 species;
	u16 ball;	//add new daycare methods, pokeball inheritance
	...
	ball = GetMonData(egg, MON_DATA_POKEBALL);	//add new daycare methods, pokeball
	...
	SetMonData(temp, MON_DATA_POKEBALL, &ball);	//add new daycare methods, pokeball
...
static void AddHatchedMonToParty(u8 id)
{
    ...
    u16 pokeNum;
    u8 name[12];
    //u16 ball;	//add new daycare methods
    u16 caughtLvl;
    u8 mapNameID;
    ...
    //ball = ITEM_POKE_BALL;	//add new daycare methods, pokeball inheritance
    //SetMonData(mon, MON_DATA_POKEBALL, &ball);	//add new daycare methods, pokeball
