...
// New items
	...
	[ITEM_OVAL_CHARM] = 				//add mints + oval charm
    {
        .name = _("Oval Charm"),
	...
	//add bottlecaps
	[ITEM_SILVER_BOTTLECAP] =
    {
        .name = _("Bottlecap"),
        .itemId = ITEM_SILVER_BOTTLECAP,
        .price = 5000,
        .description = sSilverBottlecapDesc,
        .pocket = POCKET_POWER_UP,
        .type = 1,
        .fieldUseFunc = ItemUseOutOfBattle_SilverBottlecap,
        .secondaryId = 0,
    },
	[ITEM_GOLD_BOTTLECAP] =
    {
        .name = _("G. Bottlecap"),
        .itemId = ITEM_GOLD_BOTTLECAP,
        .price = 10000,
