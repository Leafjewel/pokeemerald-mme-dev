...
//old format, but kept because 0xFFFF -> OBJ_EVENT_PAL_TAG_8 makes shadows use default Brendan Pal.
//changed Brendan Pal makes shadows look weird and OBJ_EVENT_PAL_TAG_35 is normally unused, so I put the original Pal 8 there.

const struct SpriteTemplate gFieldEffectObjectTemplate_ShadowSmall = {
    .tileTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_35,
