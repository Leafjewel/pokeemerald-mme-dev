...
static const u8 sIntrepidSwordDescription[] = _("Raises attack when enters.");
static const u8 sDauntlessShieldDescription[] = _("Raises defense when enters.");
static const u8 sBallFetchDescription[] = _("Recovers used Balls.");
static const u8 sCottonDownDescription[] = _("Slows all when attacked.");
static const u8 sPropellerTailDescription[] = _("Avoids being drawn in.");
static const u8 sMirrorArmorDescription[] = _("Reflects stat reductions.");
static const u8 sGulpMissleDescription[] = _("Sumerges and spits prey.");
static const u8 sSteamEngineDescription[] = _("Fire and Water maxes speed.");
static const u8 sPunkRockDescription[] = _("Ups and resists sound moves.");
static const u8 sSandSpitDescription[] = _("Summons sandstorm when hit.");
static const u8 sIceScalesDescription[] = _("Raises Sp. Defense.");
static const u8 sRipenDescription[] = _("Doubles berry effects.");
static const u8 sIceFaceDescription[] = _("Hail restores hit protect.");
static const u8 sPowerSpotDescription[] = _("Powers up allies.");
static const u8 sMimicryDescription[] = _("Changes type to terrain.");
static const u8 sScreenCleanerDescription[] = _("Removes all screens.");
static const u8 sSteelySpiritDescription[] = _("Ups ally steel-type moves.");
static const u8 sPerishBodyDescription[] = _("3 turns to faint when hit.");
static const u8 sWanderingSpiritDescription[] = _("Swap abilities when hit.");
static const u8 sGorillaTacticsDescription[] = _("Limit and up single attack.");
static const u8 sNeutralizingGasDescription[] = _("Cancel every ability.");
static const u8 sPastelVeilDescription[] = _("Protect allies from poison.");
static const u8 sHungerSwitchDescription[] = _("Hangry every other turn.");
...
const u8 gAbilityNames[ABILITIES_COUNT_GEN8][ABILITY_NAME_LENGTH + 1] =
{
	...
	[ABILITY_INTREPID_SWORD] = _("IntrepSword"),
    [ABILITY_DAUNTLESS_SHIELD] = _("DlessShield"),
    [ABILITY_LIBERO] = _("Libero"),
    [ABILITY_BALL_FETCH] = _("Ball Fetch"),
    [ABILITY_COTTON_DOWN] = _("Cotton Down"),
    [ABILITY_PROPELLER_TAIL] = _("PropellTail"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT_GEN8] =
{
    ...
    [ABILITY_GULP_MISSILE] = sGulpMissleDescription,
