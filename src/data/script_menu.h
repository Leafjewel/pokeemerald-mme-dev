...
const u8 *const gStdStrings[] =
{
	...
	[STDSTRING_MEDICINE] = gText_Medicine,			//more bag pockets
    [STDSTRING_BATTLEITEMS] = gText_BattleItems,	//more bag pockets
    [STDSTRING_POWERUPITEMS] = gText_PowerUp,		//more bag pockets
};
