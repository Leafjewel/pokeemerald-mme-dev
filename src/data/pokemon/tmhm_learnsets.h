...
// Entire file overhauled and reformatted to work with expanded TMs
...
static const u8 sWormadamPlantTMHMLearnset[] =
{
	TMHM(TM45_ATTRACT),
	TMHM(TM09_BULLET_SEED),
	TMHM(TM32_DOUBLE_TEAM),
...
static const u8 sMeowsticMaleTMHMLearnset[] =
{
	TMHM(TM45_ATTRACT),
	TMHM(TM04_CALM_MIND),
	TMHM(HM01_CUT),
...
const u8 *const gTMHMLearnsets[] =
{
    ...
    [SPECIES_WORMADAM] = sWormadamPlantTMHMLearnset,
    ...
    [SPECIES_MEOWSTIC_F] = sMeowsticFemaleTMHMLearnset,
    ...
    // Forms
    [SPECIES_LYCANROC_MIDNIGHT] = sLycanrocTMHMLearnset, //sLycanrocMidnightTMHMLearnset,
    [SPECIES_LYCANROC_DUSK] = sLycanrocTMHMLearnset, //sLycanrocDuskTMHMLearnset,
};
