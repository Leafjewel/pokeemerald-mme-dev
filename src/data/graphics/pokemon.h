...
const u32 gMonFrontPic_MegaBlastoise[] = INCBIN_U32("graphics/pokemon/mega_blastoise/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_MegaAerodactyl[] = INCBIN_U32("graphics/pokemon/mega_aerodactyl/anim_front.4bpp.lz");
