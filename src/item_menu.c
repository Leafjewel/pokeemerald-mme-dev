...
enum MenuActions	//register lr
{
    ...
    MENU_ACTION_GIVE,
    MENU_ACTION_CANCEL,
    //MENU_ACTION_USE_2,	//changed for bag sorting
	MENU_ACTION_USE_IN_BATTLE,
    MENU_ACTION_CHECK,
    MENU_ACTION_WALK,
	...
	MENU_ACTION_BY_NAME,	//added for bag sorting
    MENU_ACTION_BY_TYPE,	//added for bag sorting
    MENU_ACTION_BY_AMOUNT,	//added for bag sorting
    MENU_ACTION_COUNT,
};	//end section
...
//void PrintItemQuantityPlusGFX(u8 rboxId, s32 item_index_in_pocket, u8 a);		tm shops
...
const struct MenuAction sItemMenuActions[] = {
    ...
    //[MENU_ACTION_USE_2]         = {gMenuText_Use, ItemMenu_UseInBattle},	//changed for bag sorting
    [MENU_ACTION_USE_IN_BATTLE] = {gMenuText_Use, ItemMenu_UseInBattle},
	...
	[MENU_ACTION_BY_NAME]       = {sMenuText_ByName, ItemMenu_SortByName},	//added for bag sorting
    [MENU_ACTION_BY_TYPE]       = {sMenuText_ByType, ItemMenu_SortByType},	//added for bag sorting
    [MENU_ACTION_BY_AMOUNT]     = {sMenuText_ByAmount, ItemMenu_SortByAmount},	//added for bag sorting
...
//static const u8 sInBattleItemMenuActions[] = {MENU_ACTION_USE_2, MENU_ACTION_CANCEL};	//changed for bag sorting
static const u8 sInBattleItemMenuActions[] = {MENU_ACTION_USE_IN_BATTLE, MENU_ACTION_CANCEL};
...
const TaskFunc sBagMenuTasks[] = {	//end section
...
//const u8 gRegisteredSelect_Gfx[] = INCBIN_U8("graphics/interface/select_button.4bpp");	//register lr
...
struct ListBuffer1 {
    struct ListMenuItem subBuffers[129]; //[65];	edited to hopefully work with more bag pockets
};

struct ListBuffer2 {
    s8 name[129][24]; //[65][24];		edited to hopefully work with more bag pockets
};
        ...
        else
        {
            ...
            switch (listPosition)
            {
                ...
                default: // A_BUTTON
					...
					sBagMenuTasks[gBagPositionStruct.location](taskId);	//register lr
                    break;
            }
        }
    }
...
//void sub_81AC644(u8 unused)	//all non-more bag pocket edits are for register lr
...
void unknown_item_menu_type(u8 taskId)
{
    //sub_81AC644(taskId);	//register lr
...
bool8 sub_81ACDFC(s8 a)
{
    ...
    if (a > gBagMenu->unk828)
        return FALSE;
    //if (gBagMenu->unk820[a] == 14)	//register lr, bag sorting
...
void DoWallyTutorialBagMenu(void)
{
    ...
    GoToBagMenu(RETURN_LOCATION_BATTLE_2, MEDICINE_POCKET, CB2_SetUpReshowBattleScreenAfterMenu2);	//more bag pockets
}
...
static void AddBagSortSubMenu(void)
{
    switch (gBagPositionStruct.pocket + 1)
    {
        ...
        case POCKET_TM_HM:
            ...
            break;
        default:				//applies to Medicine, Battle Items, and Power Up pockets too
