...
bool8 SetupBagMenu(void)
{
    ...
    case 13:
		...
		DrawPocketIndicatorSquare(0, 0);	//more bag pockets
        DrawPocketIndicatorSquare(5, 0);	//more bag pockets
        DrawPocketIndicatorSquare(6, 0);	//more bag pockets
        DrawPocketIndicatorSquare(7, 0);	//more bag pockets
