...
static void BufferIvOrEvStats(u8 mode);	//show Vs in summary
...
// changed to allow wrapping around to first or last mon
static s8 AdvanceMonIndex(s8 delta)
{
...
static void Task_HandleReplaceMoveInput(u8 taskId)
{
    ...
    if (sub_81221EC() != TRUE)
    {
        if (gPaletteFade.active != TRUE)
        {
            ...
            else if (gMain.newKeys & A_BUTTON)	//edits to make HMs deletable
            {
...
////////////********************Colored Natures HERE***************///////////
//Colors: 8-bold blue, 7-light blue, 6-faded orange, 9-faded red, 4-dull bluish gray
//10-dull reddish brown, 11-pastel blue, 12-mid blue, 13-pale pink, 14-dull brownish red
//15-black, 3-white, 2-gray
