...
#include "list_menu.h"	//scrolling multichoices
...
//static void DrawMultichoiceMenu(u8 left, u8 top, u8 multichoiceId, bool8 ignoreBPress, u8 cursorPos)	//bw repels
static void DrawMultichoiceMenuCustom(u8 left, u8 top, u8 multichoiceId, bool8 ignoreBPress, u8 cursorPos, const struct MenuAction *actions, int count)
{
    ...
    //int width = 0;
    int i, windowId, width = 0;	//end section
    u8 newWidth;
