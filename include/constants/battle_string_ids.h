...
#define STRINGID_PLAYERLOSTAGAINSTENEMYTRAINER  548		//white out money text
#define STRINGID_PLAYERPAIDPRIZEMONEY  549				//white out money text

#define BATTLESTRINGS_COUNT     550 //548
