...
enum
{
    ...
    MART_TYPE_TM,     // eg. Gen V+ TM shop		tm shops
    MART_TYPE_DECOR,
    MART_TYPE_DECOR2,
};
...
void CreateTMShopMenu(const u16 *, u8 shopId);	//tm shops
void CreateDecorationShop1Menu(const u16 *);
void CreateDecorationShop2Menu(const u16 *);
void CB2_ExitSellMenu(void);
//tm shops
#define TMSHOP_COUNT 8
#define TMSHOP_ITEMS_COUNT 32   // If changed to be more than 16, you'll need to change the data type in tmShopFlags from u16 to u32 or u64.
